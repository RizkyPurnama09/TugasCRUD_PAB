...
$siswa = query("SELECT * FROM warga WHERE nik = $nik")[0];
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nim" value="<?= $siswa['nik']; ?>" name="nim" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="kelas" value="<?= $siswa['alamat']; ?>" name="kelas" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jurusan</label>
                        <input type="text" class="form-control w-50" id="jurusan" value="<?= $siswa['jk']; ?>" name="jurusan" autocomplete="off" required>
                    </div>
                    </div>
                    <div class="mb-3">
                        <label for="semester" class="form-label">Semester</label>
                        <input type="number" class="form-control w-50" id="semester" value="<?= $siswa['agama']; ?>" name="semester" autocomplete="off" required>
                    </div>
                    <hr>
