...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Warga</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nik" placeholder="Masukan NIK" min="1" name="nik" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="jk" placeholder="Masukkan Jenis Kelamin" name="jk" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="agama" class="form-label">Agama</label>
                        <input type="text" class="form-control w-50" id="agama" placeholder="Masukkan Agama" name="agama" autocomplete="off" required>
                    </div>
